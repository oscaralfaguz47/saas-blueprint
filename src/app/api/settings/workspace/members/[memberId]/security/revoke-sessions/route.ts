...
/**
 * PATCH /api/settings/workspace/members/[memberId]/security/revoke-sessions
 * E6: Revoke all sessions for a member (forceLogoutAt + mark Session rows revoked).
 */
export const PATCH = withErrorHandler(async (
  ...
  await writeAuditLog({
    ...
    actorContext: "TENANT",
    tenantId: tenant.id,
    action: "workspace.member_security.sessions_revoked",
    targetType: "User",
