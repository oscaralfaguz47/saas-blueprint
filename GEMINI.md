...
Before implementing any feature or code change, the agent must read and respect:

- GEMINI.md
- all files under ai-context/*

These documents define the architecture, security model, RBAC rules,
API contracts, performance standards, and definition of done.

All generated code must remain compliant with these rules.